...
writefile {file} {temp}"/K1_ron Y" {getfield {path}/K1_ron Y}
writefile {file} {temp}"/K2_ron X" {getfield {path}/K2_ron X}
writefile {file} {temp}"/mod_SynS3L1L m_SynS" {getfield {path}/mod_SynS3L1L m_SynS}
...
writefile {file} {temp}"/K1_ron Y" {getfield {path}/K1_ron Y}
writefile {file} {temp}"/K2_ron X" {getfield {path}/K2_ron X}
writefile {file} {temp}"/mod_SynS3L2L m_SynS" {getfield {path}/mod_SynS3L2L m_SynS}
...
writefile {file} {temp}"/K1_ron Y" {getfield {path}/K1_ron Y}
writefile {file} {temp}"/K2_ron X" {getfield {path}/K2_ron X}
writefile {file} {temp}"/mod_SynS3R1R m_SynS" {getfield {path}/mod_SynS3R1R m_SynS}
...
writefile {file} {temp}"/K1_ron Y" {getfield {path}/K1_ron Y}
writefile {file} {temp}"/K2_ron X" {getfield {path}/K2_ron X}
writefile {file} {temp}"/mod_SynS3R2R m_SynS" {getfield {path}/mod_SynS3R2R m_SynS}
