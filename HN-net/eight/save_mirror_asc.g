...
writefile {file} {temp}"/SynS1L4L Gk" {getfield {path}/SynS1L3L Gk}
writefile {file} {temp}"/SynS1L4L X" {getfield {path}/SynS1L3L X}
writefile {file} {temp}"/SynS1L4L Y" {getfield {path}/SynS1L3L Y}

writefile {file} {temp}"/SynS2L4L Gk" {getfield {path}/SynS2L3L Gk}
writefile {file} {temp}"/SynS2L4L X" {getfield {path}/SynS2L3L X}
writefile {file} {temp}"/SynS2L4L Y" {getfield {path}/SynS2L3L Y}
...
writefile {file} {temp}"/SynS1R4R Gk" {getfield {path}/SynS1R3R Gk}
writefile {file} {temp}"/SynS1R4R X" {getfield {path}/SynS1R3R X}
writefile {file} {temp}"/SynS1R4R Y" {getfield {path}/SynS1R3R Y}

writefile {file} {temp}"/SynS2R4R Gk" {getfield {path}/SynS2R3R Gk}
writefile {file} {temp}"/SynS2R4R X" {getfield {path}/SynS2R3R X}
writefile {file} {temp}"/SynS2R4R Y" {getfield {path}/SynS2R3R Y}
...
writefile {file} {temp}"/SynS1L3L Gk" {getfield {path}/SynS1L4L Gk}
writefile {file} {temp}"/SynS1L3L X" {getfield {path}/SynS1L4L X}
writefile {file} {temp}"/SynS1L3L Y" {getfield {path}/SynS1L4L Y}

writefile {file} {temp}"/SynS2L3L Gk" {getfield {path}/SynS2L4L Gk}
writefile {file} {temp}"/SynS2L3L X" {getfield {path}/SynS2L4L X}
writefile {file} {temp}"/SynS2L3L Y" {getfield {path}/SynS2L4L Y}
...
writefile {file} {temp}"/SynS1R3R Gk" {getfield {path}/SynS1R4R Gk}
writefile {file} {temp}"/SynS1R3R X" {getfield {path}/SynS1R4R X}
writefile {file} {temp}"/SynS1R3R Y" {getfield {path}/SynS1R4R Y}

writefile {file} {temp}"/SynS2R3R Gk" {getfield {path}/SynS2R4R Gk}
writefile {file} {temp}"/SynS2R3R X" {getfield {path}/SynS2R4R X}
writefile {file} {temp}"/SynS2R3R Y" {getfield {path}/SynS2R4R Y}
